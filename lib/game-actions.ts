...
1. **Word Selection**: 
   ...
   - The selected word should match the difficulty level: ${vocabularyLevel}. Avoid word  tree, ocean, ephemeral, table, chair, garden, cat, plastic,labyrinth, ubiquitous, quixotic, quagmire, orange, book, sky, happy, sad, smile, run, sun, ball and also ${avoidInstruction}
2. **Randomness**: 
